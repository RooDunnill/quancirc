...
def base_circuit_guide():
    ...
    print("CHAPTER 4:BASICS OF THE CIRCUIT".center(linewid, '^'))
    print(f"First we have to initalise the circuit which is done as such:")
    demo_circuit_1 = Circuit(states=1, q=2, b=2)
    ...
    demo_circuit_1.apply_gate(Hadamard, qubit=0)
    demo_circuit_1.apply_gate(X_Gate, qubit=1)
    ...
    demo_circuit_2.measure_states(qubit=0)
    ...
    povm_circuit.measure_states(povm=povms)
