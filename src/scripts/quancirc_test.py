...
print(Measure(state=q0_lw).measure_state())
print(Measure(state=q1_lw).measure_state())
print(Measure(state=qp_lw).measure_state())
print(Measure(state=qm_lw).measure_state())
print(Measure(state=qpi_lw).measure_state())
print(Measure(state=qmi_lw).measure_state())
